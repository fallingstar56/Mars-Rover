...
# 4. 机械臂复位
# 这些角度是待标定值，后续只需要改这里。
ARM_GRAB_PITCH1_DEG = ARM_INIT_PITCH1_DEG
ARM_GRAB_PITCH2_DEG = ARM_INIT_PITCH2_DEG
ARM_PLACE_PITCH1_DEG = ARM_INIT_PITCH1_DEG
ARM_PLACE_PITCH2_DEG = ARM_INIT_PITCH2_DEG
