...
RUN_MODE = "ps2"  # 可选值："idle" | "ps2" | "line_follow" | "debug" | "multi"
...
# Multi 模式抓取姿态：每行两个绝对角，共 6 个数据。
MULTI_GRAB_ROW1_PITCH1_DEG = ARM_GRAB_PITCH1_DEG
MULTI_GRAB_ROW1_PITCH2_DEG = ARM_GRAB_PITCH2_DEG
MULTI_GRAB_ROW2_PITCH1_DEG = ARM_GRAB_PITCH1_DEG
MULTI_GRAB_ROW2_PITCH2_DEG = ARM_GRAB_PITCH2_DEG
MULTI_GRAB_ROW3_PITCH1_DEG = ARM_GRAB_PITCH1_DEG
MULTI_GRAB_ROW3_PITCH2_DEG = ARM_GRAB_PITCH2_DEG

# Multi 模式放置姿态：第 1~6 个物体每个三个绝对角，共 18 个数据。
MULTI_PLACE_1_PITCH1_DEG = ARM_PLACE_PITCH1_DEG
MULTI_PLACE_1_PITCH2_DEG = ARM_PLACE_PITCH2_DEG
MULTI_PLACE_1_PITCH3_DEG = ARM_PLACE_PITCH3_DEG
MULTI_PLACE_2_PITCH1_DEG = ARM_PLACE_PITCH1_DEG
MULTI_PLACE_2_PITCH2_DEG = ARM_PLACE_PITCH2_DEG
MULTI_PLACE_2_PITCH3_DEG = ARM_PLACE_PITCH3_DEG
MULTI_PLACE_3_PITCH1_DEG = ARM_PLACE_PITCH1_DEG
MULTI_PLACE_3_PITCH2_DEG = ARM_PLACE_PITCH2_DEG
MULTI_PLACE_3_PITCH3_DEG = ARM_PLACE_PITCH3_DEG
MULTI_PLACE_4_PITCH1_DEG = ARM_PLACE_PITCH1_DEG
MULTI_PLACE_4_PITCH2_DEG = ARM_PLACE_PITCH2_DEG
MULTI_PLACE_4_PITCH3_DEG = ARM_PLACE_PITCH3_DEG
MULTI_PLACE_5_PITCH1_DEG = ARM_PLACE_PITCH1_DEG
MULTI_PLACE_5_PITCH2_DEG = ARM_PLACE_PITCH2_DEG
MULTI_PLACE_5_PITCH3_DEG = ARM_PLACE_PITCH3_DEG
MULTI_PLACE_6_PITCH1_DEG = ARM_PLACE_PITCH1_DEG
MULTI_PLACE_6_PITCH2_DEG = ARM_PLACE_PITCH2_DEG
MULTI_PLACE_6_PITCH3_DEG = ARM_PLACE_PITCH3_DEG

MULTI_GRAB_ROW_POSES = (
    (MULTI_GRAB_ROW1_PITCH1_DEG, MULTI_GRAB_ROW1_PITCH2_DEG),
    (MULTI_GRAB_ROW2_PITCH1_DEG, MULTI_GRAB_ROW2_PITCH2_DEG),
    (MULTI_GRAB_ROW3_PITCH1_DEG, MULTI_GRAB_ROW3_PITCH2_DEG),
)
MULTI_PLACE_POSES = (
    (MULTI_PLACE_1_PITCH1_DEG, MULTI_PLACE_1_PITCH2_DEG, MULTI_PLACE_1_PITCH3_DEG),
    (MULTI_PLACE_2_PITCH1_DEG, MULTI_PLACE_2_PITCH2_DEG, MULTI_PLACE_2_PITCH3_DEG),
    (MULTI_PLACE_3_PITCH1_DEG, MULTI_PLACE_3_PITCH2_DEG, MULTI_PLACE_3_PITCH3_DEG),
    (MULTI_PLACE_4_PITCH1_DEG, MULTI_PLACE_4_PITCH2_DEG, MULTI_PLACE_4_PITCH3_DEG),
    (MULTI_PLACE_5_PITCH1_DEG, MULTI_PLACE_5_PITCH2_DEG, MULTI_PLACE_5_PITCH3_DEG),
    (MULTI_PLACE_6_PITCH1_DEG, MULTI_PLACE_6_PITCH2_DEG, MULTI_PLACE_6_PITCH3_DEG),
)
